...
<div id="appCapsule">
  <div class="appContent1 mb-2">
    ...
    <!--   <div class="col-4 pl-0">
        <a href="javascript:void(0);" class="btn btn-block btn-light otpbtn" id="reg_otp" onClick="mobileveryfication();">Send OTP</a>
      </div> -->
      ...
      <i class="icon ion-ios-mail"></i>
        <input type="email" name="email" id="email" class="form-control" placeholder="Email-id" value="" >
      </div>
      <div class="inner-addon left-addon">
      ...
      <i class="icon ion-ios-gift"></i>
        ...
        <input type="text" name="rcode"  class="form-control" placeholder="Recommendation Code" value="">
      </div>
  ...
  <label class="custom-control-label text-muted" for="remember">I agree <a data-toggle="modal" href="#privacy" data-backdrop="static" data-keyboard="false">PRIVACY POLICY</a></label>
      ...
      <div class="text-center mt-3">
        <button type="submit" class="btn btn-light" style="width:264px; background-image: linear-gradient(#29B6F6, #29B6F6);"> Register </button>
        </div>
      </div>
    </form>
  </div>
    ...
    <div class="modal-content ">
      <div class="modal-body">
        <div class="text-center">
          <h5>Thank you !</h5>
          <h6>Your account has been created successfully.... Please Login</h6>
          <div class="text-center">
