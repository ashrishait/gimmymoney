...
$sql= "UPDATE `tbl_paymentsetting` SET `rechargeamount` = '$mra',`withdrawalamount` = '$mwa',`bonusamount` = '$ib',`rechargebonus` = '$rb',`level1` = '$level1',`level2` = '$level2',`level3` = '$level3',`level4` = '$level4',`level5` = '$level5' WHERE `id`= '1'";
...
<div class="col-sm-6">
              ...
              <div class="col-sm-6">
              <div class="form-group">
              <label>Level4 Commission Percent <i class="red_txt">[in %]</i></label>
              <input type="text" class="form-control"  name="level4" id="level4" required value="<?php echo $role['level4'];?>">
              </div>
              </div>
              <div class="col-sm-6">
              <div class="form-group">
              <label>Level5 Commission Percent <i class="red_txt">[in %]</i></label>
              <input type="text" class="form-control"  name="level5" id="level5" required value="<?php echo $role['level5'];?>">
              </div>
              </div>
             <div class="clearfix"></div>   
              <div class="form-group">
