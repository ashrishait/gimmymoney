      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="col-xs-12">
                <h1 style="font-weight: bold; font-size: 15px;">Note:</h1>
                <p style="font-size:15px; font-weight: bold;">
                    1. Select any one circle(sapre/bcone/emerd) before 30 second.
                </p>
                <p style="font-size:15px; font-weight: bold;">
                    2. Minimum one bet required.
                </p>
                <p style="font-size:15px; font-weight: bold;">
                    3. After publish manual result don't refresh page or don't open any other page wait until next time period to be 1:45.
                </p>
            </div>
