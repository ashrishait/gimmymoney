...
//===============================================================================================
 ...
 $userlevel2Query=mysqli_query($a,"select `code1`,(select `id` from `tbl_user` where `owncode`='$code')level2id,(select `code1` from `tbl_user` where `owncode`='$code')level2code from `tbl_user` where `id`='".$userid."'");
$userlevel2Result=mysqli_fetch_array($userlevel2Query); 
 ...
 $userlevel3Query=mysqli_query($a,"select `code2`,(select `id` from `tbl_user` where `owncode`='$code')level3id,(select `code2` from `tbl_user` where `owncode`='$code')level3code from `tbl_user` where `id`='".$userid."'");
...
$userlevel4Query=mysqli_query($a,"select `id` from `tbl_user` where `owncode`='".$level3code."'");
$userlevel4Result=mysqli_fetch_array($userlevel4Query); 
$level4id=$userlevel4Result['id'];
//=================================================================================================
$sql= mysqli_query($a,"INSERT INTO `tbl_bonussummery`(`userid`,`periodid`,`level1id`,`level2id`,`level3id`,`level4id`,`level1amount`,`level2amount`,`level3amount`,`level4amount`,`tradeamount`,`createdate`) VALUES ('".$userid."','".$periodid."','".$level1id."','".$level2id."','".$level3id."','".$level4id."','".$level1."','".$level2."','".$level3."','".$level4."','".$tradeamount."','".$today."')");
...
$sql= mysqli_query($a,"INSERT INTO `tbl_bonussummery`(`userid`,`periodid`,`level1id`,`level2id`,`level3id`,`level4id`,`level1amount`,`level2amount`,`level3amount`,`level4amount`,`tradeamount`,`createdate`) VALUES ('".$userid."','0','".$refuserid."','0','0','0','110','0','0','0','0','".$today."')");
  }
}
