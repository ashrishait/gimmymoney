...
<div class="container">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a data-toggle="tab" href="#menu1">BANK</a></li>
    </ul>
  ...
  <div id="menu1" class="tab-pane fade in active">    
        ...
        <div class="box" style="margin-bottom: 0;">
            ...
            <p>
                ...
                <span class="value">67876767611</span>
                <button  class="btn copyBtn" data-clipboard-text="67876767611">Copy</button>
            </p>
            <p>
                <span class="label">IFSC Code&nbsp;:</span>
                <span class="value">IDFB0020126</span>
                <button class="btn copyBtn" data-clipboard-text="IDFB0020126">Copy</button>
            </p>
             <p>
                <span class="label">Bank Name&nbsp;:</span>
                <span class="value">IDFC FIRST BANK</span>
                <button class="btn copyBtn" data-clipboard-text="IDFC FIRST BANK">Copy</button>
            </p>
             <p>
                <span class="label">Name&nbsp;:</span>
                <span class="value">Trading Consultancy</span>
                <button class="btn copyBtn" data-clipboard-text="Trading Consultancy">Copy</button>
            </p>
        </div>    
  </div>
</div>
